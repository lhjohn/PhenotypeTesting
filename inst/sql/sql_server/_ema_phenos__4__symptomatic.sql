...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4329518,4174894,444413,437663,4141062,4212763,44809208,4152360,4039793,4077057,4039791,4151775,4265708)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4223659,4272240,439926)
...
WHERE C.measurement_date >= DATEFROMPARTS(2020, 1, 1)
AND C.value_as_number >= 38.0000
-- End Measurement Criteria
